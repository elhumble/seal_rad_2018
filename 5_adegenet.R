...
# filter vcf file for unrelated pups
# 99% genotyping rate and maf 0.05
...
system("vcftools --vcf data/structure/maf05_g99.recode.vcf --plink --out data/structure/maf05_g99")
system("plink --file data/structure/maf05_g99 --make-bed --recode --out data/structure/maf05_g99")
...
system("scripts/recode_full_map.sh data/structure/maf05_g99.map data/structure/maf05_g99.map")

# Make bed
system("plink --file data/structure/maf05_g99 --make-bed --out data/structure/maf05_g99 --allow-extra-chr --debug")

# Run PLINK --indep
system("plink --bfile data/structure/maf05_g99 --indep 50 5 2 --nonfounders --out data/structure/maf05_g99 --allow-extra-chr --debug")
system("wc -l data/structure/maf05_g99.prune.in")

# LD filter
# Make raw file for adegenet
system("plink --bfile data/structure/maf05_g99 --extract data/structure/maf05_g99.prune.in --out data/structure/maf05_g99_ld --recodeA --allow-extra-chr --debug")

# Made ped file for structure
system("plink --bfile data/structure/maf05_g99 --extract data/structure/maf05_g99.prune.in --out data/structure/maf05_g99_ld --recode --allow-extra-chr --debug")
...
gl <- read.PLINK("data/structure/maf05_g99_ld.raw")
...
system("cut -d ' ' -f 7- data/structure/maf05_g99_ld.ped > data/structure/temp/A")
...
# get ids
system("awk '{print $1}' data/structure/maf05_g99_ld.ped > data/structure/temp/ids")
...
#~~ Get microsatellite summary stats for Supplementary
...
#png("figs/ms_pca1_3.png", units = "in", res = 300, width = 8, height = 6)
